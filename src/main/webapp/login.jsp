...
<script type="text/javascript" src="jquery/bootstrap_3.3.0/js/bootstrap.min.js"></script>
	<script>
		...
		$(function () {
			...
			$("#submitAtc").click(function () {
				login();
			})
		})
		function login() {
			var name=$.trim($("#loginName").val());
			var pasw=$.trim($("#loginPwd").val());
			if(name==""||pasw==""){
				$("#msg").html("请输入账号或密码！");
				return false;
			}
			...
			<form action="workbench/index.jsp" class="form-horizontal" role="form">
				<div class="form-group form-group-lg">
					...
					<div class="checkbox"  style="position: relative;top: 30px; left: 10px;">
							<span id="msg" style="color: #c9302c"></span>
					</div>
					<button type="button" id="submitAtc" class="btn btn-primary btn-lg btn-block"  style="width: 350px; position: relative;top: 45px;">登录</button>
				</div>
			</form>
		</div>
	</div>
