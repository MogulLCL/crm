            ...
            success :function (data) {
                ...
                if(data.data.size!=0) {
                    $.each(data.data.list, function (i, a) {
                        html+='<tr>'
                        html+='<td><input type="checkbox" id="'+a.id+'"/></td>'
                        html+='<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/clue/detail.jsp?id='+a.id+'\';">'+a.fullname+'</a></td>'
                        html+='<td>'+a.company+'</td>'
                        html+='<td>'+a.phone+'</td>'
                        html+='<td>'+a.mphone+'</td>'
                        html+='<td>'+a.source+'</td>'
                        html+='<td>'+a.owner+'</td>'
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 40px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button type="button" class="btn btn-primary" id="createrBtn"><span class="glyphicon glyphicon-plus"></span> 创建</button>
